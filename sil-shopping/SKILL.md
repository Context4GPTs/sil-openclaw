...
| "what does my shopper know?" / "which domains has it learned?" | `sil_profile_list` | [`references/manage_domains.md`](references/manage_domains.md) |
