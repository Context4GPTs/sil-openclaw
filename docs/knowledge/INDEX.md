...
|---|---|---|---|
| [[sil-api-catalog-contract]] | sil-api catalog reads — FLAT `{ ucp, products, … }` envelope (no `result` wrapper), bare POST /catalog/{search,lookup}, OPEN `SearchFilters` (serviceability filters fail GREEN on a wrong key), @sil/schemas is wire truth (not @ucp-js/sdk) | sil-api, catalog, search, lookup, contract, wire-types, envelope, filters, cross-sibling, gotcha | 2026-06-11 |
