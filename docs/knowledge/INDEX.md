...
|---|---|---|---|
| [[sil-api-catalog-contract]] | sil-api catalog reads — FLAT `{ ucp, products, … }` envelope (no `result` wrapper), bare POST /catalog/{search,lookup}, @sil/schemas is wire truth (not @ucp-js/sdk) | sil-api, catalog, search, lookup, contract, wire-types, envelope, cross-sibling, gotcha | 2026-06-10 |
